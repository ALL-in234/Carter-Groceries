...
<body>
  ...
  <script type="text/babel">
    ...
    const MainScreen = ({ onShopClick, onGamesClick, onCalendarClick, currentScreen }) => (
      <div className="flex flex-col items-center h-screen bg-gray-100 p-4">
        ...
        <div className="flex w-full mb-4">
          <button
            onClick={onShopClick}
            className="flex-1 bg-pink-500 text-white font-bold py-3 rounded-l-lg text-lg flex items-center justify-center hover:bg-pink-600 transition-colors"
            aria-label="前往商店"
          >
          ...
          <button
            ...
            className="flex-1 bg-yellow-400 text-black font-bold py-3 rounded-r-lg text-lg flex items-center justify-center hover:bg-yellow-500 transition-colors"
            aria-label="前往遊戲與活動"
          >
    ...
    // 商店畫面組件
    const ShopScreen = ({ onBackClick, currentScreen }) => (
      <div className="flex flex-col items-center h-screen bg-gray-100 p-4">
        <div className="flex justify-between w-full mb-4">
          <button className="text-2xl text-gray-600 icon-hover" aria-label="開啟選單">
            <i className="fas fa-bars"></i>
        ...
        <div className="flex w-full justify-end mb-4">
          <button
            onClick={onBackClick}
            className="bg-black text-white font-bold py-2 px-4 rounded-full hover:bg-gray-800 transition-colors"
            aria-label="返回主畫面"
          >
            返回
          </button>
        ...
        <div className="grid grid-cols-2 gap-4 w-full">
          ...
          <button className="flex items-center justify-center bg-teal-400 text-white font-bold py-4 rounded-lg hover:bg-teal-500 transition-colors" aria-label="汽車選項">
    ...
    const GamesScreen = ({ onBackClick, currentScreen }) => (
      <div className="flex flex-col items-center h-screen bg-gray-100 p-4">
        ...
        {/* 示例遊戲內容 */}
        <div className="grid grid-cols-2 gap-4 w-full">
          <button className="flex items-center justify-center bg-blue-500 text-white font-bold py-4 rounded-lg hover:bg-blue-600 transition-colors" aria-label="遊戲1">
            <i className="fas fa-dice mr-2"></i> 遊戲 1
          </button>
          <button className="flex items-center justify-center bg-orange-500 text-white font-bold py-4 rounded-lg hover:bg-orange-600 transition-colors" aria-label="活動1">
    ...
    const App = () => {
      ...
      return (
        <div>
          ...
          {screen === 'shop' && <ShopScreen onBackClick={handleBackClick} currentScreen={screen} />}
